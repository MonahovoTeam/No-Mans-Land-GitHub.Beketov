...
// thirstTextCritical
_ttc = selectRandom ["Вы не можете сглотнуть слюну.","Вам сложно передвигаться.","Вам холодно.","Ваша кожа сморщилась.","Вы стали хуже видеть.","У вас распухает язык.","У вас болит голова.","У вас кружится голова.","Вам хочется спать."];
...
if (KSS_hunger > 10 && KSS_hunger <= 40) then {
	systemChat format["%1", _ht]; 
		...
		if (KSS_hunger > 0 && KSS_hunger <= 10) then {
			...
			titletext ["Вы теряете сознание из-за голода!","PLAIN",1];
			2 fadeSound 0.2;
